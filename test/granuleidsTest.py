#-----------------------------------------------------------------------------
# Name:        granuleidsTest.py
# Purpose:     Various unittests for granule module.
#
# Author:      Gerald Manipon
#
# Created:     Wed Apr 12 15:18:11 2006
...
from eosUtils.granule2 import getGranuleIdsByOrbitTable, InvalidDateError

thisDir=os.path.dirname(os.path.abspath(__file__))

class granuleTestCase(unittest.TestCase):
    """Test case for functions/clases in granule module."""

    def testShortTimespanGlobalCoverage(self):
        """Test new getGranuleIdsByOrbitTable function with a short timespan
        and global coverage."""
        ...
        #get ids
        t=time.time()
        ids=getGranuleIdsByOrbitTable(dataset,starttime, endtime, minLat, maxLat, minLon, maxLon)
        t2=time.time()

        #make assertions - 576 granules returned by ECHO's WIST tool
        self.assertEqual(len(ids), 576)

        print "\ntestShortTimespanGlobalCoverage took: %02.2f seconds." % (t2-t)

    def testLongTimespanGlobalCoverage(self):
        """Test new getGranuleIdsByOrbitTable function with a long timespan
        and global coverage."""
        ...
        print "\ntestLongTimespanGlobalCoverage took: %02.2f seconds." % (t2-t)
        
    def testLongTimespanGlobalCoverage2(self):
        """Test new getGranuleIdsByOrbitTable function with a long timespan (past table data)
        and global coverage."""
        ...
        print "\ntestLongTimespanGlobalCoverage2 took: %02.2f seconds." % (t2-t)
    ...
    def testShortTimespanSmallCoverage(self):
        ...
        print "\ntestShortTimespanSmallCoverage took: %02.2f seconds." % (t2-t)
    ...
    def testLongTimespanSmallCoverage(self):
        ...
        #make assertions
        self.assertEqual(len(ids), 2463)

        print "\ntestLongTimespanSmallCoverage took: %02.2f seconds." % (t2-t)
    ...
    def testLongTimespanSmallCoverage2(self):
        ...
        #make assertions
        self.assertEqual(len(ids), 2439)

        print "\ntestLongTimespanSmallCoverage2 took: %02.2f seconds." % (t2-t)
    ...
    def testGranuleidMatch(self):
        ...
        for metFile in metFiles:
            ...
            #get ids
            ids=getGranuleIdsByOrbitTable(dataset, starttime, endtime, -180., 180. -90., 90.)
    ...
    def testTimeAndSpace(self):
        ...
        #get ids
        t=time.time()
        infoDict=getGranuleIdsByOrbitTable(dataset,starttime, endtime, minLat, maxLat, minLon, maxLon,
        ...
        print "\ntestTimeAndSpace took: %02.2f seconds." % (t2-t)
    ...
    def testShortTimespanSmallCoverageVsLadsweb(self):
        ...
        print "\ntestShortTimespanSmallCoverageVsLadsweb took: %02.2f seconds." % (t2-t)
        
    def testDataTableExceptionBeforeFirstDate(self):
        """Test data table exception for query before first date."""
        ...
        #make assertions
        self.assertRaises(InvalidDateError, getGranuleIdsByOrbitTable, dataset,
                          starttime, endtime, minLat, maxLat, minLon, maxLon)
    ...
    def testGranuleidQuery(self):
        ...
        #get ids
        idsGlobal=getGranuleIdsByOrbitTable(dataset,starttime, endtime, -90., 90., -180., 180.)
...
def getTestSuite():
    ...
    myTestSuite.addTest(granuleTestCase("testShortTimespanGlobalCoverage"))
    myTestSuite.addTest(granuleTestCase("testLongTimespanGlobalCoverage"))
    myTestSuite.addTest(granuleTestCase("testLongTimespanGlobalCoverage2"))
    myTestSuite.addTest(granuleTestCase("testShortTimespanSmallCoverage"))
    myTestSuite.addTest(granuleTestCase("testLongTimespanSmallCoverage"))
    myTestSuite.addTest(granuleTestCase("testLongTimespanSmallCoverage2"))
    myTestSuite.addTest(granuleTestCase("testGranuleidMatch"))
    myTestSuite.addTest(granuleTestCase("testTimeAndSpace"))
    myTestSuite.addTest(granuleTestCase("testShortTimespanSmallCoverageVsLadsweb"))
    myTestSuite.addTest(granuleTestCase("testDataTableExceptionBeforeFirstDate"))
    myTestSuite.addTest(granuleTestCase("testDataTableAfterLastDate"))
    myTestSuite.addTest(granuleTestCase("testGranuleidQuery"))
    myTestSuite.addTest(granuleTestCase("testGranuleidQuery2"))
